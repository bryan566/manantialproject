...
<div class="bg-dark">
    <div class="content container-fluid" style="height: 25rem;">
        ...
        <div class="row align-items-center">
            <div class="col">
                <h1 class="page-header-title text-white">Agregar Category</h1>
            </div>
            <!-- End Col -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="category_name" id="category_name" placeholder="Digita una Categoria" required>
                                </div>
                                <!-- End Form -->
                            </div>
                            <!-- End Col -->
