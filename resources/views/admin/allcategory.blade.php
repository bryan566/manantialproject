...
<div class="bg-dark">
    <div class="content container-fluid" style="height: 27rem;">
        ...
        <div class="row align-items-center">
            <div class="col">
                <h1 class="page-header-title text-white">Listar Category</h1>
            </div>
            ...
            <div class="d-grid d-sm-flex gap-2">
                ...
                <div class="dropdown">
                    ...
                    <a class="btn btn-primary" href="{{ route('addcategory') }}">
                        <i class="bi-person-plus-fill me-1"></i> Nueva Categoria
                    </a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('deletecategory', $category->id) }}" class="btn btn-success">Eliminar</a>
