...
<div class="bg-dark">
    <div class="content container-fluid" style="height: 27rem;">
        ...
        <div class="row align-items-center">
            <div class="col">
                <h1 class="page-header-title text-white">Listar Etiquetas QR</h1>
            </div>
        ...
        <div class="card-header card-header-content-md-between">
            ...
            <div class="d-grid d-sm-flex gap-2">
                ...
                <div class="dropdown">
                    ...
                    <a class="btn btn-primary" href="{{ route('createcodigo') }}">
                        <i class="bi-person-plus-fill me-1"></i> Generar QR CODE
                    </a>
            ...
            <table id="datatable" class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {!! DNS2D::getBarcodeHTML("$pedido->cliente, $pedido->pedido_code",'QRCODE') !!}
